...
export default function LoyaltyTab({ user }: { user: any }) {
  return (
    <div className="space-y-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
             <div>
                ...
                <h2 className="text-3xl md:text-4xl font-serif font-bold mb-3 flex items-center gap-3">
                   ...
                   Đại sứ Nhân ái <span className="text-emerald-200 font-sans text-2xl font-normal">(Hạng Vàng)</span>
                </h2>
                <p className="text-emerald-50 text-sm max-w-xl leading-relaxed">
                   Cảm ơn bạn đã đồng hành cùng Quỹ. Bạn đang sở hữu trọn bộ quyền lợi và đặc quyền cao cấp nhất dành cho nhà hảo tâm.
                </p>
             </div>
       ...
       {/* 3. BỘ NHẬN DIỆN ĐẠI SỨ (MỚI THÊM GIỐNG ẢNH) */}
       <div>
