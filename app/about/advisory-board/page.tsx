...
const TeamPage: React.FC = () => {
  const teamMembers = [
    {
      name: 'Ngô Sĩ Đình',
      position: 'Director of Caritas Vietnam',
      image: '/images/ngoSiDinh.png', // Giữ nguyên nếu bạn có ảnh local, hoặc thay bằng URL thực tế
    },
    {
      name: 'Lê Xuân Hy',
      position: 'Professor - Seattle University',
      image: '/images/leXuanHy.png',
    },
    {
      name: 'Hà Thu Thanh',
      position: 'Chairwoman - Deloitte Vietnam',
