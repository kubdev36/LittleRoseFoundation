...
const TeamPage: React.FC = () => {
  const teamMembers = [
    {
      name: 'Trần Duy Cảnh',
      position: 'TGĐ Công ty Dentons Luật Việt - Trưởng Ban kiểm soát',
      image: '/images/tranDuyCanh.png',
    },
    {
      name: 'Hoàng Thị Lệ Trinh',
      position: 'Phó TGĐ Tập đoàn GD Nguyễn Hoàng - Phó Trưởng Ban kiểm soát',
      image: '/images/avatar.jpg',
    },
    {
      name: 'Thái Bá Cần',
      position: 'Ủy viên Ban kiểm soát',
      image: '/images/avatar.jpg',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto py-16 px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">
            Ban kiểm soát Quỹ từ thiện Bông hồng nhỏ
          </h2>
