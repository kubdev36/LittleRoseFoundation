...
import { BookOpen, HeartPulse, Users, CircleDollarSign } from 'lucide-react';
      ...
      <div className="relative h-96 w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          ...
          <p className="text-lg">
            ...
            / <span className="text-green-300">Về chúng tôi</span>
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-16 px-8 text-gray-800">
        ...
        <div className="max-w-4xl mx-auto mb-16 ">
          <p className="text-lg leading-relaxed mb-8">
            Quỹ từ thiện <span className='text-red-600'> Bông hồng nhỏ (Little Roses Foundation)</span> Bông hồng nhỏ (Little Roses Foundation) là quỹ từ thiện không vì mục tiêu lợi nhuận, hướng đến các hoạt động thiện nguyện đa dạng phục vụ cộng đồng. Được thúc đẩy bởi truyền thống gia đình và tấm lòng người Mẹ, NHG là thành viên sáng lập chủ chốt của Quỹ.
          </p>
          ...
          <p className="text-lg leading-relaxed mb-12">
            Quỹ phục vụ chủ yếu trên các lĩnh vực sức khỏe – giáo dục , được cấp phép bởi <span className='text-red-600'>Bộ Nội Vụ</span> để hoạt động trên phạm vi toàn quốc và đón nhận sự trợ giúp của quốc tế.
          </p>
        </div>
        ...
        <div className="bg-gray-200 py-16 px-8 rounded-2xl">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              ...
              className="inline-block bg-green-600 text-white font-semibold py-4 px-10 rounded-lg hover:bg-green-700 transition duration-300 shadow-lg text-lg uppercase tracking-wider"
            >
